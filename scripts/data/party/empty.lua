local character, super = Class(PartyMember, "empty")
...
function character:init()
    ...
    -- Attacks
    self:addAttack("ice_attack")
    self.attackname = "Stab"
    ...
    self.menu_icon = "party/empty/head"
    -- Path to head icons used in battle
    self.head_icons = "party/empty/icon"
    -- Name sprite (optional)
    self.name_sprite = "party/empty/name"
