local character, super = Class(PartyMember, "wolfye")
...
function character:init()
    ...
    self.menu_icon = "party/wolfye/head"
    -- Path to head icons used in battle
    self.head_icons = "party/wolfye/icon"
    -- Path to status icons used in battle
    self.status_icons = "party/wolfye/status"
    -- Name sprite (optional)
    self.name_sprite = "party/wolfye/name"
    ...
    self.head_icon_offset = {5, 0}
    -- Status icon position offset (optional)
    self.status_icon_offset = {1, 0}
